    ...
    for i_r = 1:max_rounds-1
        ...
        if (fb_scheme == "FB")
            ...
            if (inner_scheme == "FB")
                ...
                K_err = length(err_seq);
                [errDataInSeq, err_rr_len] = conv_enc(err_seq, targetErrCodeRate, 1);
                ...
                if (comm_mod == 1)
                    ...
                    txSig_FB = lteSymbolModulate(errDataInSeq,modulation);
                end
            ...
            [err_seq_est, crc_chk_FB] = conv_dec(rxLLR_FB, err_rr_len, 1);
            ...
            if ((i_r < max_rounds - 1) || (i_r == max_rounds -1 && crc_chk_FB))
            ...
            [dataIn, rr_len] = conv_enc(data, R, 1);
            ...
            % Rate recovery and Decoding
            [data_est_FB, crc_chk_FB_HARQ] = conv_dec(rxLLR_FB_HARQ, rr_len, 1);
