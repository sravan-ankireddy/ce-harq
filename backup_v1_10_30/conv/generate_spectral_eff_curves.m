...
res_folder_prefix = 'bler_data_converse';
...
if (run_grid_search == 1)
    ...
    title(title_str);
    ar_common_str = [res_folder_fb sprintf('/Avg_rounds_LDPC_%d_rate_%.3f_err_thr_%.3f_to_%.3f_max_rounds_%d_numF_%d',N,R, err_thr_grid(1), err_thr_grid(end), max_rounds, nFrames)];
