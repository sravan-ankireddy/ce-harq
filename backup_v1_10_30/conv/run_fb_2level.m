    ...
    for i_on = 1:nOut
        ...
        parfor i_n = 1:nMiniFrames
            ...
            if (num_err > 0 && max_rounds > 1)
                out = retransmit_func_FB_2level(channel,SNRdB,modulation,length(rxLLR),K,targetCodeRate,dec_type,data,rxLLR,data_est,err_thr,err_thr_ada_list_est,err_thr_ada_scheme,i_s,max_rounds,counts,num_err,comm_mod,mod_approx,seed);
